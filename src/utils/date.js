export default {
        ...
        return this.extends(true, new Date(target), {
            ...
            state() {
                ...
                if (this.target > bs.year) {
                    return {
                        year: this.count(bs.year)
                    }
                }
                if (this.target > bs.month) {
                    return {
                        month: this.count(bs.month)
                    }
                }
                if (this.target > bs.day) {
                    return {
                        day: this.count(bs.day)
                    }
                }
                if (this.target > bs.hour) {
                    return {
                        hour: this.count(bs.hour)
                    }
                }
                if (this.target > bs.minute) {
                    return {
                        minute: this.count(bs.minute)
                    }
                }
                return {
                    second: this.target
    ...
    handleGetAjaxParams(formObj, param) {
        ...
        for (let key in formObj) {
            if (formObj[key] !== '' && formObj[key] !== this.lang.SELECT_ALL) {
